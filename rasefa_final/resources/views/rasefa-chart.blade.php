...
<body>
 ...
 <header class="ds-header" id="site-header">
        <div class="container">
                    ...
                    <div style="position: relative; margin: 10px;">
                        <div class="btn-toolbar position-relative top-0 start-50 translate-middle-x" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group" role="group" aria-label="First group">
                                <a href="{{ asset('penjualantoko-chart') }}" class="btn btn-pink">Pemasukkan Toko</a>
                                <a href="{{ asset('rasefa-chart') }}" class="btn btn-pink">Pemasukkan Produk</a>
                                <a href="{{ asset('total-kategori') }}" class="btn btn-pink">Pemasukkan Kategori</a>
                                <a href="{{ asset('jumlah-toko') }}" class="btn btn-pink">Jumlah Pesanan Toko</a>
                                <a href="{{ asset('jumlah-produk') }}" class="btn btn-pink">Jumlah Pesanan Produk</a>
                                <a href="{{ asset('jumlah-kategori') }}" class="btn btn-pink">Jumlah Pesanan Kategori</a>
                            </div>
                        </div>
                    </div>
                    <li>
            ...
            <br>
            <h2 class="ds-headingeda">eda Penjualan Charts</h2>
        </div>
    </header>
