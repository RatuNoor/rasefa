...
<body>
    <div class="ds-header-inner">
        <h2 href="{{route('register')}}" class="ds-logo" style="margin-left:30px">
            <span>R</span>asefa
        </h2> 
    </div>
    <div class="ds-katalog">
        <div class="container">
            <h2 class="ds-heading">Registrasi Sebagai Pembeli</h2>    
            <form class="login-form" action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="no_telfon" id="no_telfon" required>
                </div>
