...
<body>
    <div class="ds-header-inner">
        <h2 href="{{route('toko.register')}}" class="ds-logo" style="margin-left:30px">
            <span>R</span>asefa
        </h2> 
    </div>
    <div class="ds-katalog">
        <div class="container">
            <h2 class="ds-heading">Registrasi Sebagai Toko</h2>
            <form class="login-form" action="{{ route('toko.register') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alamat_toko" id="alamat_toko" required>
                </div>

                <div class="form-group">
                    <label for="username_toko">Username Toko</label>
                    <input type="text" name="username_toko" id="username_toko" required>
                </div>
