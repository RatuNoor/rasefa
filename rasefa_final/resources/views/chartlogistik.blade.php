        ...
        <div class="container">
            <div class="ds-header-inner">
                ...
                <div class="btn-group" role="group" aria-label="First group">
                    <a href="{{ asset('chartlogistik') }}" class="btn btn-secondary btn-pink ">Jumlah Pengiriman</a>
                    <a href="{{ asset('statuslog') }}" class="btn btn-secondary btn-pink">Status Pengiriman</a>
                    <a href="{{ asset('belumdikirim') }}" class="btn btn-secondary btn-pink">Belum Dikirm</a>
                    <a href="{{ asset('sudahdikirim') }}" class="btn btn-secondary btn-pink">Sudah Dikirim</a>
                    <a href="{{ asset('sudahsampai') }}" class="btn btn-secondary btn-pink">Sudah Sampai</a>
                    <a href="{{ asset('sudahdikonfirmasi') }}" class="btn btn-secondary btn-pink">Sudah Dikonfirmasi</a>
                </div>
                    <li>
            ...
            <br>
            <h2 class="ds-headingeda">eda Pengiriman Charts</h2>
        </div>
    </header>
